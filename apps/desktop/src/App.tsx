        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            {showDateNav && (
              ...
              >
                <button onClick={() => setDate(d => stepDate(d, -1))} style={navBtnStyle} title="Previous day">
                  <ChevronLeft size={14} />
                </button>
                <div
                  style={{
            ...
            {showDateNav && !isToday && (
              <button onClick={() => setDate("today")} style={outlineBtnStyle}>
